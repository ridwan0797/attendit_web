...
const columns = [
  ...
  { name: 'tanggal_sakit', align: 'center', label: 'TANGGAL SAKIT', field: 'tgl_sakit', sortable: true },
...
const rows = [
  {
    nama: 'Rizki',
    tgl_sakit: '25-09-2021',
    keterangan: 'DBD dirawat di RS',
    status: 'Pending',
    lampiran: ''
  },
  {
    nama: 'Deri Agria',
    tgl_sakit: '28-09-2021',
    keterangan: 'Positive COVID 19',
    status: 'Approve',
    lampiran: ''
  }
]

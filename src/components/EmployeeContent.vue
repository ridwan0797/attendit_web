<template>
  <div class="q-mt-xl">
    <div class="text-center text-weight-thin q-mt-sm text-subtitle1 text-grey-7">{{$props.dataEmployee.number}}</div>
    ...
    <div class="text-center text-weight-bold q-mt-sm text-h6">
      {{$props.dataEmployee.name}}
    </div>

    <div class="text-center text-caption">
      {{$props.dataEmployee.employee_type}}
    </div>

    <div class="full-width row justify-end q-mt-md">
      <div class="col text-right"><q-btn unelevated round color="grey-4" icon="textsms" ></q-btn></div>
      <div class="col text-center"><q-btn unelevated round color="grey-4" icon="phone" ></q-btn></div>
      <div class="col text-left"><q-btn unelevated round color="grey-4" icon="email" ></q-btn></div>
    </div>

    <div class="row q-col-gutter-xs text-subtitle1 q-mt-lg">
      ...
      <div class="col text-center">
        ...
        <div class="text-weight-thin">
          {{$props.dataEmployee.marital_status}}
        </div>
      </div>
    </div>
    ...
    <div class="row q-col-gutter-xs text-subtitle1 q-mt-lg">
      <div class="col text-center">
        ...
        <div class="text-weight-thin">
          {{$props.dataEmployee.date_of_birth}}
        </div>
      </div>
      ...
      <div class="col text-center">
        ...
        <div class="text-weight-thin overflow ellipsis">
